...
experiment_name='Qwen3-4B-tmn-reweight'
...
# Algorithm
# ============================================================================
adv_estimator=tmn_grpo

loss_mode="vanilla"

difficulty_reweight=True
difficulty_smooth_alpha=0.8
...
actor_ppo_max_token_len_per_gpu=$(((max_prompt_length + max_response_length) / CP))
...
PYTHONUNBUFFERED=1 python3 -m recipe.dapo.main_dapo --config-name='dapo_megatron_trainer' \
    ...
    +algorithm.difficulty_smooth_alpha=${difficulty_smooth_alpha} \
